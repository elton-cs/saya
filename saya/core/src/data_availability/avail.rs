...
#[derive(Debug)]
pub struct AvailDataAvailabilityBackend<P> {
    rpc_url: Url,
    auth_token: String,
...
#[derive(Debug)]
pub struct AvailDataAvailabilityBackendBuilder<P> {
    rpc_url: Url,
    auth_token: String,
...
impl<P> AvailDataAvailabilityBackend<P>
where
    P: DataAvailabilityPayload,
{
    async fn run(mut self) {
        loop {
            ...
            info!(
                "Proof made availalbe on Avail block #{}. Commitment: {}",
                avail_block,
